...
<body id="page-top">
    ...
    <section style="margin-top: 100px" class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">RESERVACIONES</h2>
            <!-- Icon Divider-->
            ...
            <main class="flex-shrink-0">
                <div class="container">
                    ...
                    <form action=" {{route('agregar.reserva.admin')}} " method="GET">
                        <div class="container">
                            <div class="row">
                                <h4>Agregar reservación</h4>
                                <p><b>Escoja la fecha que desea realizar su reservación</b></p>
                    ...
                    <table class="table table-hover table-bordered my-3" aria-describedby="titulo">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>3000</td>
                                <td>
                                    <a href="{{route('editar.reserva.admin')}}" class="btn btn-warning btn-sm me-2">Editar</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Desea eliminar la reservación?</p>
                </div>
                <div class="modal-footer">
                    <form id="form-elimina" action=" {{ route('eliminar.reserva.admin') }} " method="GET">
