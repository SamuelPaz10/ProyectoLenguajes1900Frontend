...
<body id="page-top">
    ...
    <section style="margin-top: 100px" class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <form action=" {{ route('guardar.reserva.admin') }} " method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" aria-label="Default select example">
                                        <option value="1">0801</option>
                                        <option value="2">0208</option>
                            ...
                            <div class="col-7">
                                ...
                                <div style="text-align: center; margin-top:100px" class="col-12">
                                    ...
                                    <a href="{{ route('ver.habitaciones.fecha') }}" class="btn btn-danger">Regresar</a>
                                </div>
