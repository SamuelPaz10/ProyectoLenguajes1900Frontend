    ...
    <section style="margin-top: 100px" class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <form>
                ...
                <button type="submit" class="btn btn-primary">Buscar fecha</button>
            </form>

            <form action="{{route('guardar.reserva')}} " method="POST">
                <main class="flex-shrink-0">
                    <div class="container">
                        <h3 class="my-3" id="titulo">Habitaciones</h3>
                        ...
                        <table class="table table-hover table-bordered my-3" aria-describedby="titulo">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href=" {{ route('crear.reserva') }}"
                                            class="btn btn-secondary btn-sm me-2">Seleccionar</a>
                                    </td>
                                </tr>
