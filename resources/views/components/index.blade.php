...
<body id="page-top">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href=" {{ route('obtener.reserva') }} ">Mis reservas</a></li>
                            <li><a class="dropdown-item" href=" {{ route('editar.usuario') }} ">Editar usuario</a></li>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img style="width: 40%" class="masthead-avatar mb-5"
            ...
            <div class="text-center mt-4">
                <a class="btn btn-xl btn-outline-light" href=" {{ route('ver.habitaciones') }} ">
                    <i class="fas fa-house me-2"></i>
                    Ver Habitaciones
                </a>
                <p>Inicia sesión para ver las habitaciones.</p>
            </div>
        </div>
    </header>
    <!-- Portfolio Section-->
