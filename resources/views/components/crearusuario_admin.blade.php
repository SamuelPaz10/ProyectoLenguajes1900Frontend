...
<body id="page-top">
    ...
    <section style="margin-top: 100px" class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <h4 class="page-section-heading text-center text-uppercase text-secondary mb-0">Crear Usuario</h4>
            <!-- Icon Divider-->
            ...
            <main class="flex-shrink-0">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div style="background-color: rgba(179, 238, 218, 0.63); border-radius:20px; padding:20px" class="col-4">
                            <form action=" {{ route('guardar.usuario.admin') }} " method="POST">
                                @csrf
                                <div class="mb-3">
